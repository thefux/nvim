if not vim.g.vscode then
	...
	keymap(
		{ "n" },
		"<leader>x",
		"<Cmd>call VSCodeCall('workbench.action.files.save', {})<CR> | <Cmd>call VSCodeCall('workbench.action.closeActiveEditor', {})<CR>",
		opts
	)
	keymap(
		{ "n" },
		"<leader>xa",
		"<Cmd>call VSCodeCall('workbench.action.files.saveAll', {})<CR> | <Cmd>call VSCodeCall('workbench.action.closeAllEditors', {})<CR>",
		opts
	)
